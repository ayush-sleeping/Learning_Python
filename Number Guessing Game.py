...
number = random.randint(1, 20)      # randint function to generate the random number b/w 1 to 9

 # number of chances to be given to the user to guess the number or it is the inputs given by user
                                    # into input box here number of chances are 5
chances = 0
